...
def user_to_csv(list_user:list[MoodelUser],file_csv,course:str) -> None:
    with open(file_csv, 'w', newline='',encoding='utf=8') as csvfile:
        fieldnames = ['username','firstname','lastname','email']
        writer = csv.DictWriter(csvfile, fieldnames=(fieldnames +['course1']))
...
course = 'Организационные и психолого-педагогические основы инклюзивного высшего образования'
...
user_to_csv(list_user,output_file,course)